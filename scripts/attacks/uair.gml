...
set_window_value(AT_UAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.75);
...
set_window_value(AT_UAIR, 3, AG_WINDOW_ANIM_FRAME_START, 13);
...
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 93);
