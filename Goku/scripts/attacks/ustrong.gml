...
set_attack_value(AT_USTRONG, AG_USES_CUSTOM_GRAVITY, true); //you have to set custom gravity for every window individually

var grav = gravity_speed; //equal to 0.55 currently.
...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GRAVITY, grav);
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GRAVITY, grav);

set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 3);
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, grav);

set_window_value(AT_USTRONG, 4, AG_WINDOW_LENGTH, 24); // 15
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 1.15); //change this one to affect the endlag's gravity
