...
switch (state)
{
    case PS_DASH: case PS_DASH_START: case PS_DASH_TURN: case PS_DASH_STOP:
        hurtboxID.sprite_index = sprite_get("dashhurt_box");
        break;
    case PS_CROUCH:
    ...
    case PS_ATTACK_GROUND: case PS_ATTACK_AIR:
        if (attack != AT_NSPECIAL && attack != AT_USPECIAL && attack != AT_FSPECIAL && attack != AT_TAUNT){
			...
			hurtboxID.sprite_index = sprite_get("hurt_box");
		}
        break;
    default:
